...
namespace ServerLibrary.Repositories.Implementations
{
    public class CountryRepository(AppDbContext appDbContext) : IGenericRepositoryInterface<Country>
    {
        ...
        {
            if (!await CheckName(item.Name!)) return new GeneralResponse(false, "Bu isimde bir ülke zaten var.");
        ...
        private static GeneralResponse NotFound() => new(false, "Ülke bulunamadı.");
