...
namespace ServerLibrary.Repositories.Implementations
{
    public class TownRepository(AppDbContext appDbContext) : IGenericRepositoryInterface<Town>
    {
        ...
        {
            if (!await CheckName(item.Name!)) return new GeneralResponse(false, "Bu isimde bir ilçe zaten var.");
        ...
        private static GeneralResponse NotFound() => new(false, "İlçe bulunamadı.");
