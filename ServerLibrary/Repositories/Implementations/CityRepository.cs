...
namespace ServerLibrary.Repositories.Implementations
{
    public class CityRepository(AppDbContext appDbContext) : IGenericRepositoryInterface<City>
    {
        ...
        {
            if (!await CheckName(item.Name!)) return new GeneralResponse(false, "Bu isimde bir şehir zaten var.");
        ...
        private static GeneralResponse NotFound() => new(false, "Şehir bulunamadı.");
